...
public class TestNGParameters {
    ...
    @Test
    @Parameters({"browser", "url", "firstName", "lastName", "emailId"})
    public void handlePageFactory(String browser, String url, String firstName, String lastName, String emailId) throws InterruptedException {

        if (browser.equalsIgnoreCase("chrome")) {
            WebDriverManager.chromedriver().setup();
            driver = new ChromeDriver();
        } else {
            System.out.println("The Provided Browser Does Not Exist");
        }
        ...
        emailNameInput.sendKeys(emailId);
